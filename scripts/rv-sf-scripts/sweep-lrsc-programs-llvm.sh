...
do
  case "$opt" in
    ...
    r)
      ...
      mkdir rv-sf-llvm-workloads
      for cpu in 8 4 2; do
        for insnBetween in 1 2 3 4; do
          python scripts/rv-sf-scripts/gen_riscv_lrsc_llvm.py --threads $cpu --iterations 5000 \
            --unconditional --between $insnBetween --output \
            rv-sf-llvm-workloads/unconditional-threads-$cpu-bb-$insnBetween.cpp

          ./scripts/rv-sf-scripts/compile_llvm.sh \
            rv-sf-llvm-workloads/unconditional-threads-$cpu-bb-$insnBetween
          ...
          for cbe in 1 4 8 12 16 20 50 80 100 150; do
            ./build/RISCV_NoRuby_SF/gem5.opt -r -d \
              ...
              --cmd rv-sf-llvm-workloads/unconditional-threads-$cpu-bb-$insnBetween &
        ...
        for insnBetween in 1 2 3 4; do
          for insnExitPath in 1 2 4 8 12 16 20 50; do
            python scripts/rv-sf-scripts/gen_riscv_lrsc_llvm.py --threads $cpu --iterations 5000 \
              ...
              --output rv-sf-llvm-workloads/conditional-no-retry-threads-$cpu-bb-$insnBetween-eb-$insnExitPath.cpp

            ./scripts/rv-sf-scripts/compile_llvm.sh \
              rv-sf-llvm-workloads/conditional-no-retry-threads-$cpu-bb-$insnBetween-eb-$insnExitPath
            ...
            for cbe in 1 4 8 12 16 20 50; do
              ./build/RISCV_NoRuby_SF/gem5.opt -r -d \
                ...
                configs/riscv-sf-experiments/riscv_minor_one_level_cache.py \
                --cbe-insn-count-limit $cbe --num-cpus $simcpu --mem-size=8GB \
                --cmd rv-sf-llvm-workloads/conditional-no-retry-threads-$cpu-bb-$insnBetween-eb-$insnExitPath &
        ...
        for insnBetween in 1 2 3 4; do
          for insnRetryPath in 1 2 4 8 12 16 20 50; do
            ...
            --output rv-sf-llvm-workloads/conditional-retry-threads-$cpu-bb-$insnBetween-rb-$insnRetryPath.cpp

            ./scripts/rv-sf-scripts/compile_llvm.sh \
              rv-sf-llvm-workloads/conditional-retry-threads-$cpu-bb-$insnBetween-rb-$insnRetryPath
            ...
            for cbe in 1 4 8 12 16 20 50; do
              ./build/RISCV_NoRuby_SF/gem5.opt -r -d \
                ...
                configs/riscv-sf-experiments/riscv_minor_one_level_cache.py \
                --cbe-insn-count-limit $cbe --num-cpus $simcpu --mem-size=8GB \
                --cmd rv-sf-llvm-workloads/conditional-retry-threads-$cpu-bb-$insnBetween-rb-$insnRetryPath &
        ...
        echo "SLEEPING FOR 10m 3"
        sleep 10m
        echo "WAKING UP 3"
      done
      ;;
    c)
      rm -rf rv-sf-llvm-workloads/
 esac
done
